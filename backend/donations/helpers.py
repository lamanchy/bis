...
def upload_bank_records(file):
    ...
    column_names = ["Datum", "Objem", "Měna", "Číslo účtu", "Protiúčet", "Kód banky", "KS", "VS", "SS", "Poznámka", "Zpráva pro příjemce", "Typ", "Upřesnění - objem", "Upřesnění - měna", "VS",]
    ...
    for row in data:
        ...
        Donation.objects.get_or_create(
            ...
            info="\n".join([f"{column_names[i]}: {row[i]}" for i in range(len(column_names))])
        )